...
export const newsCategories: NewsCategory[] = [
  ...
  },
  {
    ...
    icon: Globe,
    color: "text-sky-500",
    sources: getSourcesFor('General', 8),
  },
  {
    id: 'sports',
    title: "Sports",
    ...
    sources: getSourcesFor('Sports', 8),
    url: '/sports-news',
  },
  {
    id: 'entertainment',
    ...
    icon: Film,
    color: "text-rose-500",
    sources: getSourcesFor('Entertainment', 8),
  },
  {
    id: 'business',
    title: "Business",
    ...
    sources: getSourcesFor('Business', 8),
    url: '/business-news',
  },
  {
    id: 'health',
    ...
    icon: HeartPulse,
    color: "text-red-500",
    sources: getSourcesFor('Health', 8),
  },
  {
    id: 'science',
    title: "Science",
    icon: FlaskConical,
    color: "text-blue-500",
    sources: getSourcesFor('Science', 8),
  },
  {
    id: 'politics',
    title: "Politics",
    ...
    sources: getSourcesFor('Politics', 8),
  },
  {
    id: 'us-news',
    title: "U.S. News",
