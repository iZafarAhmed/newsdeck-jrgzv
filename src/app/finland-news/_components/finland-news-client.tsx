...
interface FinlandNewsClientProps {
...
export function FinlandNewsClient({ sources }: FinlandNewsClientProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold tracking-tight">Finland News Websites</h1>
        <p className="text-lg text-muted-foreground mt-2">
          A collection of popular news sources from Finland.
        </p>
      </div>
