...
import type { HindiNewsSource } from "@/data/hindi-news-sources";
import { Button } from "@/components/ui/button";

interface HindiNewsClientProps {
  sources: HindiNewsSource[];
}

type SortableColumn = keyof HindiNewsSource;
...
export function HindiNewsClient({ sources }: HindiNewsClientProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold tracking-tight">Hindi News Websites</h1>
        <p className="text-lg text-muted-foreground mt-2">
          Explore top Hindi news sources from India.
        </p>
      </div>
            ...
            {filteredAndSortedSources.map((source, index) => (
              <TableRow key={source.name} className="hover:bg-muted/50">
                ...
                <TableCell className="text-muted-foreground">
                  {source.facebookUrl && source.facebookUrl !== 'N/A' && source.facebookFollowers && source.facebookFollowers !== 'N/A' ? (
                ...
                <TableCell className="text-muted-foreground">
                  {source.xUrl && source.xUrl !== 'N/A' && source.xFollowers && source.xFollowers !== 'N/A' ? (
                ...
                <TableCell className="text-muted-foreground">
                  {source.instagramUrl && source.instagramUrl !== 'N/A' && source.instagramFollowers && source.instagramFollowers !== 'N/A' ? (
