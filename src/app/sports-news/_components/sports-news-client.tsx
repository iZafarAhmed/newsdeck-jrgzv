...
import type { NewsSite as SportsNewsSource } from "@/data/all-news-sources";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";

interface SportsNewsClientProps {
  sources: SportsNewsSource[];
}

type SortableColumn = keyof SportsNewsSource;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold tracking-tight">Sports News Websites</h1>
        <p className="text-lg text-muted-foreground mt-2">
          Explore top sports news sources from around the world.
        </p>
      </div>
